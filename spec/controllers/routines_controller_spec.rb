  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved routine as @routine" do
        ...
        post :create, {:routine => { "title" => "invalid value" }}, valid_session
        assigns(:routine).should be_a_new(Routine)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested routine" do
        ...
        Routine.any_instance.should_receive(:update_attributes).with({ "title" => "MyString" })
        put :update, {:id => routine.to_param, :routine => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the routine as @routine" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Routine.any_instance.stub(:save).and_return(false)
        put :update, {:id => routine.to_param, :routine => { "title" => "invalid value" }}, valid_session
        assigns(:routine).should eq(routine)
      end
